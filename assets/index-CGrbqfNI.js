...
`,d=()=>"/front_5th_chapter1-1",S=[{path:d()+"/",render:e=>{e.innerHTML=w()}},{path:d()+"/login",guard:()=>!i.isLoggedIn(),redirect:d()+"/",render:(e,t)=>{e.innerHTML=g(),h(e,t)}},{path:d()+"/profile",guard:()=>i.isLoggedIn(),redirect:d()+"/login",render:e=>{e.innerHTML=x("/profile"),y(e)}},{path:d()+"404",render:e=>{e.innerHTML=L()}}];function $(e){S.forEach(({path:t,guard:r,redirect:o,render:s})=>{e.addRoute(t,n=>{if(r&&!r()){e.navigateTo(o);return}s(n,e)})})}function E(e,{isHashMode:t=!1}={}){const r={};let o="";function s(){return t?window.location.hash.replace(/^#/,"")||"/":window.location.pathname||"/"}function n(a){const u=r[a];u?u(e):r[404]&&r[404](e)}function l(){o=s(),n(o)}function m(a){t?window.location.hash=a:(history.pushState({},"",a),l())}function b(a,u){r[a]=u}function p(){o=s(),n(o),t&&window.addEventListener("hashchange",l),window.addEventListener("popstate",l)}return{addRoute:b,navigateTo:m,start:p,getCurrentPath:s}}function P(e=!1){const t=document.getElementById("root");if(!t)return;const r=E(t,{isHashMode:e});i.init(),i.subscribe(()=>{r.start()}),$(r),v(r),r.start()}P();
